...
if not os.path.exists(dstdir):
	...
	os.system('mkdir ' + dstdir + '/orgimage')
	os.system('mkdir ' + dstdir + '/degimage')
	os.system('mkdir ' + dstdir + '/sobelimage')
else:
...
for line in  os.popen('ls ' + orgdir + ' | grep -v images*').readlines():
	...
	os.system('cp ' + degdir + '/' + filename + '/nrmse/' + filename + '-mean* ' +  dstdir + '/sobelimage') 
