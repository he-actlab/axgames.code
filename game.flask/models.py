...
class Play(Base):
	...
	winning_game1 = Column(Float)

	# Game2
	error_rate_game2 = Column(Integer)
	bet_game2 = Column(Integer)
	winning_game2 = Column(Float)

	# Game3
	is_correct = Column(Integer)
	error_rate_game3 = Column(Integer)
	bet_game3 = Column(Integer)
	winning_game3 = Column(Float)

	def __init__(self, session_id, game_type, image_id, deg_image_id, selection, bet_game1, winning_game1, error_rate_game2, bet_game2, winning_game2, is_correct, error_rate_game3, bet_game3, winning_game3):
